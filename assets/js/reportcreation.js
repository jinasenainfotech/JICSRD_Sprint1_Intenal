...
function calculation(row) {
	// row = 	$(this).attr('data-id');
	// ebit
	$("#ebit_" + row).val((parseFloat($("#profit_before_tax_" + row).val()) + parseFloat($("#interest_expense_gross_" + row).val())) - parseFloat($("#tax_benefit_expense_" + row).val()));

	// Gross Profit
	$("#gross_profit_" + row).val(parseFloat($("#sales_" + row).val()) - parseFloat($("#cost_of_sales_" + row).val()));

	var x1 = parseFloat($("#sales_" + row).val());
	var x2 = parseFloat($("#cost_of_sales_" + row).val());
	var x3 = parseFloat($("#gross_profit_" + row).val());
	var x4 = parseFloat($("#other_income_" + row).val());
	var x5 = parseFloat($("#depreciation_" + row).val());
	var x6 = parseFloat($("#amortisation_" + row).val());
	var x7 = parseFloat($("#impairment_" + row).val());
	var x8 = parseFloat($("#interest_expense_gross_" + row).val());
	var x9 = parseFloat($("#operating_lease_expense_" + row).val());
	var x10 = parseFloat($("#finance_lease_hire_purchase_charges_" + row).val());
	var x11 = parseFloat($("#non_recurring_gains_losses_" + row).val());
	var x12 = parseFloat($("#other_gains_losses_" + row).val());
	var x13 = parseFloat($('#other_expenses_' + row).val());
	var x14 = parseFloat($('#ebit_' + row).val());
	var x15 = parseFloat($('#ebitda_' + row).val());
	var x16 = parseFloat($('#normalised_ebitda_' + row).val());
	var x17 = parseFloat($('#profit_before_tax_' + row).val());
	var x18 = parseFloat($("#profit_before_tax_after_abnormals_" + row).val());
	var x19 = parseFloat($('#tax_benefit_expense_' + row).val());
	var x20 = parseFloat($('#profit_after_tax_' + row).val());
	var x21 = parseFloat($('#distribution_ordividends_' + row).val());
	var x22 = parseFloat($('#other_post_tax_items_gains_losses_' + row).val());
	var x23 = parseFloat($('#profit_after_tax_distribution_' + row).val());
	var x25 = parseFloat($('#cash_' + row).val());
	var x26 = parseFloat($('#trade_debtors_' + row).val());
	var x27 = parseFloat($('#total_inventories_' + row).val());
	var x28 = parseFloat($('#loans_to_related_parties_1_' + row).val());
	var x29 = parseFloat($('#other_current_assets_' + row).val());
	var x30 = parseFloat($('#total_current_assets_' + row).val());
	var x31 = parseFloat($('#fixed_assets_' + row).val());
	var x32 = parseFloat($('#net_intangibles_' + row).val());
	var x33 = parseFloat($('#loan_to_related_parties_2_' + row).val());
	var x34 = parseFloat($('#other_non_current_assets_' + row).val());
	var x35 = parseFloat($('#total_non_curent_assets_' + row).val());
	var x36 = parseFloat($('#total_assets_' + row).val());
	var x38 = parseFloat($('#trade_creditors_' + row).val());
	var x39 = parseFloat($('#interest_bearing_debt_1_' + row).val());
	var x40 = parseFloat($('#lone_from_related_parties_' + row).val());
	var x41 = parseFloat($('#other_current_liabilities_' + row).val());
	var x42 = parseFloat($('#total_current_liabilities_' + row).val());
	var x43 = parseFloat($('#total_current_liabilities_2_' + row).val());
	var x44 = parseFloat($('#loans_from_related_parites_' + row).val());
	var x45 = parseFloat($('#other_non_current_liabilities_' + row).val());
	var x46 = parseFloat($('#total_non_current_liabilities_' + row).val());
	var x47 = parseFloat($('#total_liabilities_' + row).val());
	var x49 = parseFloat($('#share_capital_' + row).val());
	var x50 = parseFloat($('#prefence_shares_' + row).val());
	var x51 = parseFloat($('#treasury_shares_' + row).val());
	var x52 = parseFloat($('#equity_owner_ships_' + row).val());
	var x53 = parseFloat($('#total_reserves_' + row).val());
	var x54 = parseFloat($('#ratained_earning_' + row).val());
	var x55 = parseFloat($('#minorty_interest_' + row).val());
	var x56 = parseFloat($('#total_equity_' + row).val());
	var x57 = parseFloat($('#balance_' + row).val());
